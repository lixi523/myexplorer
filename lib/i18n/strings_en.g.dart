...
class Translations$folderAccess$en {
	...
	/// en: 'The system is blocking access to this folder. Try again or check the folder permissions.'
	String get deniedBody => 'The system is blocking access to this folder. Try again or check the folder permissions.';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'folderAccess.deniedBody' => 'The system is blocking access to this folder. Try again or check the folder permissions.',
