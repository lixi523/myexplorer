// GENERATED. Codepoints from phosphor-icons (MIT). See third_party/phosphor/LICENSE.

import 'package:flutter/widgets.dart';

class MyExplorerIconsRegular {
  const MyExplorerIconsRegular();
...
class MyExplorerIconsBold {
  const MyExplorerIconsBold();
  static const IconData check = IconData(
    0xe182,
...
class MyExplorerIconsFill {
  const MyExplorerIconsFill();
  static const IconData check = IconData(
    0xe182,
