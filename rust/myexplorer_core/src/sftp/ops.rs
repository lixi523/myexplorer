...
/// Zwalnia string zwrócony przez `myexplorer_sftp_*`.
/// # Safety
/// `ptr` musi pochodzić z funkcji SFTP tego modułu i być zwolniony dokładnie raz.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_free_cstr(ptr: *mut c_char) {
    if ptr.is_null() {
        return;
    }
...
///         w przeciwnym razie wskaźnik do komunikatu błędu (zwolnić przez `myexplorer_sftp_free_cstr`).
...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_session_open(
    host: *const c_char,
    port: u16,
    user: *const c_char,
    auth_kind: u32,
...
/// # Safety: zamyka sesję; `id` musi pochodzić z `myexplorer_sftp_session_open`.
#[no_mangle]
pub extern "C" fn myexplorer_sftp_session_close(id: u64) {
    session::block(async {
...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_realpath(session_id: u64, path: *const c_char) -> *mut c_char {
...
/// Listing pojedynczego katalogu. Zwraca codec buffer (jak `myexplorer_list`)
/// lub null gdy błąd.
///
/// # Safety
/// `path` musi być NUL-terminated, `out_len` writable.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_list(
    session_id: u64,
    path: *const c_char,
    out_len: *mut usize,
) -> *mut u8 {
...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_stat(
    session_id: u64,
    path: *const c_char,
    out: *mut SftpStat,
) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_read(
    session_id: u64,
    path: *const c_char,
    out_len: *mut usize,
) -> *mut u8 {
...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_read_range(
    session_id: u64,
    path: *const c_char,
    start: i64,
    len: i64,
...
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_write(
    session_id: u64,
    path: *const c_char,
    data: *const u8,
    len: usize,
...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_write_chunk(
    session_id: u64,
    path: *const c_char,
    data: *const u8,
    len: usize,
...
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_open_writer(
    session_id: u64,
    path: *const c_char,
    append: i32,
...
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_writer_write(
    writer_id: u64,
    data: *const u8,
    len: usize,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn myexplorer_sftp_writer_close(writer_id: u64) -> i32 {
    let result = session::block(async move {
        let writer = {
...
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_open_reader(
    session_id: u64,
    path: *const c_char,
...
/// Zwraca bufor (zwolnić przez `myexplorer_free`), `out_len` = liczba odczytanych.
/// `out_len == 0` przy zwróconym non-null oznacza EOF.
///
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_reader_read(
    reader_id: u64,
    max_len: usize,
    out_len: *mut usize,
) -> *mut u8 {
...
/// Zamyka reader.
#[no_mangle]
pub extern "C" fn myexplorer_sftp_reader_close(reader_id: u64) -> i32 {
    session::block(async move {
...
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_mkdir(
    session_id: u64,
    path: *const c_char,
    recursive: i32,
) -> i32 {
...
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_remove(
    session_id: u64,
    path: *const c_char,
    recursive: i32,
) -> i32 {
...
/// # Safety: standardowe wymagania FFI.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_sftp_rename(
    session_id: u64,
    from: *const c_char,
    to: *const c_char,
) -> i32 {
