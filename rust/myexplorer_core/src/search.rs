...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_search(
    root: *const c_char,
    query: *const c_char,
    include_hidden: bool,
    mode: u8,
...
#[no_mangle]
pub unsafe extern "C" fn myexplorer_search_start(
    root: *const c_char,
    query: *const c_char,
    include_hidden: bool,
    mode: u8,
...
/// # Safety
/// `session` must come from `myexplorer_search_start`; out pointers writable.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_search_poll(
...
/// # Safety
/// `session` must come from `myexplorer_search_start`.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_search_cancel(session: *mut SearchSession) {
    if session.is_null() {
        return;
    }
...
/// # Safety
/// `session` must come from `myexplorer_search_start` and be used exactly once.
#[no_mangle]
pub unsafe extern "C" fn myexplorer_search_free(session: *mut SearchSession) {
    if session.is_null() {
        return;
    }
